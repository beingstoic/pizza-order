		...
		for (;;) {
			while (true) // to get main menu choice
			{
				...
				try {
					...
					boolean isValid = service.validateMenuChoice(menuChoice.toString());
					if (isValid)
						break;
					...
					try {
						...
						if (isValid) {
							...
							case "1":
								...
								pizza.setTotalPrice(pizza.getTotalPrice() + 30);
							case "2":
								pizza.setToppingName("Mushroom");
								pizza.setTotalPrice(pizza.getTotalPrice() + 50);
							case "3":
								pizza.setToppingName("Jalapeno");
								pizza.setTotalPrice(pizza.getTotalPrice() + 70);
							case "4":
								pizza.setToppingName("Paneer");
								pizza.setTotalPrice(pizza.getTotalPrice() + 85);
							default:
								break;
							}
							break;
